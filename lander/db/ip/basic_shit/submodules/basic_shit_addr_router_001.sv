...
module basic_shit_addr_router_001_default_decode
  #(
...
module basic_shit_addr_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 32'h301000;
    ...
    basic_shit_addr_router_001_default_decode the_default_decode(
