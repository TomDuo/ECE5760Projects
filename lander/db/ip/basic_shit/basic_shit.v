...
`timescale 1 ps / 1 ps
module basic_shit (
		output wire        video_vga_controller_0_external_interface_VS,    // video_vga_controller_0_external_interface.VS
		output wire [7:0]  video_vga_controller_0_external_interface_B,     //                                          .B
		output wire        video_vga_controller_0_external_interface_BLANK, //                                          .BLANK
		output wire        video_vga_controller_0_external_interface_HS,    //                                          .HS
		output wire        video_vga_controller_0_external_interface_SYNC,  //                                          .SYNC
		output wire        video_vga_controller_0_external_interface_CLK,   //                                          .CLK
		...
		output wire        lcd_0_external_RW,                               //                            lcd_0_external.RW
		inout  wire [7:0]  lcd_0_external_data,                             //                                          .data
		output wire        lcd_0_external_E,                                //                                          .E
		output wire        lcd_0_external_RS,                               //                                          .RS
		input  wire        reset_reset_n,                                   //                                     reset.reset_n
		input  wire        clk_clk,                                         //                                       clk.clk
		output wire        sram_0_external_interface_CE_N,                  //                 sram_0_external_interface.CE_N
